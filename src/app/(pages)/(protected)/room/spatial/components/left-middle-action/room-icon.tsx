...
export default function RoomIcon(props: Props) {
  ...
  return (
    <div className={`h-9 w-9 hover:bg-slate-200 transition-all rounded-full p-1 ${openDrawMenu ? "scale-110 bg-slate-200" : "scale-100"} flex justify-center items-center cursor-pointer relative`}>
